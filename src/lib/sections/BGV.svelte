...
<Paragraph>
  ...
  into my program. I started on the Indifference Engine (
  ...
  ), so called because it allowed for people's ranked choice votes to have ties in
  them. It started out based on my earlier IRV / Borda blend but eventually was migrated
  to the{' '}
